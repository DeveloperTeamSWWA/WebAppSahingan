...
<head>
  ...
  <link rel="stylesheet" href="CSS/addrate.css">
...
<form action ="AddedRate.php" method="post">
<div class="wrapf">
<input type = "text" name="price" id="price" onkeyup="numbersOnly(this)" maxlength="3" class="searchTerm" placeholder="Price">
<script>
